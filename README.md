...
The detector classified my modern academic Research Statement as **AI (7% Human)**. This confirms the model isn't detecting "humanity"—it's detecting "19th-century fiction style." Modern academic writing falls outside its training distribution, so it fails by default.
